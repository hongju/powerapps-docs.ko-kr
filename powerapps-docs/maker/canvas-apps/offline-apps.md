...
2. **새로 만들기** > **빈 앱** > **전화 레이아웃**을 클릭하거나 누릅니다.
...
4. **이미지** 컨트롤을 추가하고, **Image** 속성을 **ThisItem.UserDetails.ProfileImageUrl**로 설정합니다.

### <a name="step-5-add-a-connection-status-label"></a>5단계: 연결 상태 레이블 추가
새 **레이블** 컨트롤을 삽입하고 **Text** 속성을 다음 수식으로 설정합니다.
