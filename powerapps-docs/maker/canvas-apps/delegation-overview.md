...
500이 레코드의 기본 수입니다.  이 숫자는 파일 탭으로 이동하여 왼쪽 탐색 창에서 앱 설정을 선택하고 실험적 기능 아래에서 변경할 수 있습니다.  여기에서 "위임할 수 없는 쿼리에 대한 데이터 행 제한" 설정을 찾을 수 있습니다. 이 설정은 1에서 2000까지 변경할 수 있습니다.  이 설정은 앱 전체에 적용됩니다.

경우에 따라 2000(아니면 1000 또는 1500)이 시나리오의 필요를 충족하는지 알 수 있습니다.  신중하게, 시나리오에 맞도록 숫자를 늘릴 수 있습니다.  이 숫자를 늘릴수록 앱의 성능은 저하될 수 있습니다. 열이 많이 있는 넓은 테이블의 경우 특히 그렇습니다.  가장 좋은 방법은 가능한 것은 항상 위임하는 것입니다.

앱이 대규모 데이터 집합으로 확장될 수 있도록 하려면 이 설정을 1로 줄입니다.  위임할 수 없는 항목이 있으면 단일 레코드만 반환하며 이렇게 하면 앱을 테스트할 때 쉽게 감지할 수 있습니다.  이를 통해 개념 증명 앱을 프로덕션 환경에서 사용하려는 경우 예기치 않은 문제를 방지할 수 있습니다.
