...
사용자의 장치에 파일을 다운로드 하는 것 뿐만 아니라 업로드 하고, SharePoint 목록 또는 Common Data Service 엔터티에서 파일을 삭제 할 수 있는 컨트롤입니다.
...
**첨부 파일** 컨트롤을 사용 하여 SharePoint 목록 또는 Common Data Service 엔터티에 파일을 추가 하고, 열고, 삭제 합니다.
