...
> [!IMPORTANT]
>   만약 기존의 구성이 있다면, 2018년 9월 30일 이전에 최대한 신속하게 업데이트 하십시오. PowerApps 앱이 위치한 지역에 대한 IP 주소의 목록을 확인하여 맞춰 주십시오.
...
이 목록은 PowerApps Studio이 통신하고 사용하는 모든 서비스들 입니다. 네트워크는 이러한 서비스를 차단하지 **않아야** 합니다.
