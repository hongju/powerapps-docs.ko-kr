...
# <a name="solutions-overview"></a>솔루션 개요  
 ...
 모델 기반 앱을 구입하거나, 공유하거나, 한 조직에서 다른 조직으로 전송할 수 있도록 솔루션이 있습니다. [AppSource](https://appsource.microsoft.com/) 또는 ISV(독립 소프트웨어 공급 업체)로부터 솔루션을 얻을 수 있습니다. 솔루션은 환경에 앱으로 가져오거나 기존 앱에 사용자 지정 집합을 적용할 수 있는 파일입니다.  
...
-   PowerApps 환경을 직접 사용자 지정할 때  **Common Data Services 기본 솔루션**이라는 특별한 솔루션을 사용합니다. 이 솔루션에는 시스템의 모든 솔루션 구성 요소가 포함되어 있습니다.  
