...
현재 [web.powerapps.com](1.md)에서 미리 보기로 사용할 수 있는 첫 번째 PowerApps 분석 보고서 및 **앱 사용 현황 보고서**를 소개합니다.
...
*참고: 분석 보고서는 미리 보기로 제공되지만, 유효한 PowerApps 라이선스가 있는 모든 사용자가 보고서에 액세스하여 이용해 볼 수 있습니다.*

## <a name="where-do-i-find-my-apps-reports"></a>내 앱 보고서는 어디서 찾을 수 있습니까?
다음 단계를 통해 앱의 보고서를 볼 수 있습니다.

1. [web.powerapps.com](1.md)으로 이동합니다.
...
특정 피드백, 질문 또는 요청이 있는 경우 [PowerApps 아이디어 포럼](2.md)으로 알려주세요.
