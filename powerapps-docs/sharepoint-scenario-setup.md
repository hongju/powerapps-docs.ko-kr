...
**참고:** SharePoint에서 생성되고 기본적으로 숨겨지는 **ID** 열을 사용합니다. 간단히 하기 위해 기본 데이터 형식을 사용하지만, 실제 앱에서는 **개인 또는 그룹**과 같이 **Requestor** 열에 대해 더 복잡한 형식을 사용할 수 있습니다. PowerApps에서 지원하는 데이터 형식에 대한 자세한 내용은 [Microsoft PowerApps에서 SharePoint로 연결](https://powerapps.microsoft.com/tutorials/connection-sharepoint-online/#known-issues)을 참조하세요.
...
**참고:** 이 단계에서는 Internet Explorer를 사용합니다.
...
2. [이름]에서 "설명"을 입력한 다음 **만들기**를 클릭하거나 탭합니다.
   
    ![설명 열 만들기](./media/sharepoint-scenario-setup/01-01-05-description-column.png)
...
1. PowerApps Studio에서 **project-management-app.msapp**을 엽니다.
2. PowerApps에서 SharePoint를 사용할 수 있도록 **허용**을 클릭하거나 탭합니다.
3. 리본의 **보기** 탭에서 **데이터 원본**을 클릭하거나 탭합니다.
   
    ![PowerApps 데이터 원본](./media/sharepoint-scenario-setup/01-03-01-data-sources.png)
4. 오른쪽 창에서 **프로젝트 세부 정보** 옆의 줄임표(**. . .**), **제거**를 차례로 클릭하거나 탭합니다.
...
7. **SharePoint**, **연결**을 차례로 클릭하거나 탭합니다.
...
9. **프로젝트 세부 정보** 목록을 선택한 다음 **연결**을 클릭하거나 탭합니다.
    ...
    이제 오른쪽 창의 **데이터 원본** 탭에서 사용자가 만든 연결이 표시됩니다.
   
    ![데이터 원본](./media/sharepoint-scenario-setup/01-03-03e-data-sources.png)
10. 오른쪽 창에서 **프로젝트 세부 정보** 옆의 줄임표(**. . .**), **새로 고침**을 차례로 클릭하거나 탭합니다.
...
4. SharePoint Online 사이트에 대한 URL을 입력한 다음 **확인**을 클릭하거나 탭합니다.
...
6. 조직 계정(SharePoint Online에 액세스하는 데 사용하는 계정)으로 로그인한 다음 **연결**을 클릭하거나 탭합니다.
