...
Office 365 또는 Dynamics 365 플랜에 PowerApps가 포함된 경우:
...
> [!NOTE]
> 조직 내에서 개별적으로 사용 약관에 동의할 필요 없이 PowerApps 평가판 라이선스를 가져와 다수의 사용자에게 배포하고자 하는 IT 관리자의 경우 [PowerApps 플랜 2 구독 평가판][6]에 등록하면 됩니다. 관리자 평가판에 등록하려면 Office 365 전역 또는 대금 청구 관리자거나 새 테넌트를 만들어야 합니다.  [자세히 알아보기](signup-for-powerapps-admin.md)

## <a name="individual-signup-has-been-turned-off"></a>개인용 등록 해제됨
PowerApps에 등록할 때 다음 메시지가 표시될 수 있습니다.

![IT 부서에서 등록을 해제했습니다.](./media/signup-for-powerapps/Individual-sign-up-turned-off.png)
