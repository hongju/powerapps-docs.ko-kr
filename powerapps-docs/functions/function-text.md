...
| **m** |앞에 오는 0 없이 숫자로 분을 표시합니다.  참고: **m** 또는 **mm** 코드는 **h** 또는 **hh** 코드 바로 뒤나 **ss** 코드 바로 앞에 나타나야 하며, 그렇지 않으면 **텍스트**는 분 대신 월을 반환합니다. |
| **mm** |해당하는 경우 앞에 0을 붙여 숫자로 분을 표시합니다. 참고: **m** 또는 **mm** 자리 표시자는 **h** 또는 **hh** 자리 표시자 바로 뒤나 **ss** 자리 표시자 바로 앞에 나타나야 합니다. 그렇지 않으면 **텍스트**는 분 대신 월을 반환합니다. |
...
**참고:** 이후 버전에서 이 자리 표시자의 구문은 Excel에서 지원하는 비슷하지만 다른 자리 표시자로 인한 혼동을 피하기 위해 변경할 수 있습니다.
