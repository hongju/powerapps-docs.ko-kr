...
이 토픽의 단계에 따라 사용자가 Dynamics 365에 있는 연락처를 찾아 보고, 추가하며 삭제 및 업데이트할 수 있는 앱을 만듭니다. 사용자는 [브라우저](../run-app-browser.md) 또는 휴대폰과 같은 [모바일 장치](../run-app-client.md)에서 앱을 실행할 수 있습니다.
